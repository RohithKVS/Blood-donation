...
<br>
<br>
<h3>This is to inform you that your account, once closed cannot be restored and your name will no longer be visible under the donors list.<br></h3>
<h4>Do you want to close your account permanently?</h4>
<br>
<form name="close" action="closeacc3.php">
<input type="submit" value="Yes" class="button">
<a href="afterdonorlogin.php" class="lin">No</a>
</form>
</center>
	         </div>
          </div>		
