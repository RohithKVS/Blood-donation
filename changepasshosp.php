      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="changepasshosp.php">Change Password</a></li>
...
<br>
<br>
<form name="donreg2" method="post" autocomplete="off" onsubmit="return Validate()" action="changepassh.php">
<table id="form" border="3" style="border:2px solid;height:300px;border-collapse:collapse">
<tr>
<td>Old Password:</td>
