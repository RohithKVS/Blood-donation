    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <h1 class="page-header" align="center">Welcome <?= $fname.' '.$lname ?></h1>
          <div class="row placeholders">

1. To view your profile, click 'View Profile'.<br>
2. To edit your profile, click 'Edit Profile'.<br>
3. To change your password, click 'Change Password'.<br>
4. To change your status, click 'Change Status'.<br>
5. To close your account permanently , click 'Close Account'<br>
	         </div>
          </div>		
