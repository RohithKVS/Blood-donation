...
require 'database.php';
    ...
    $result1 = mysql_query("SELECT * FROM donor WHERE email='$email'");

    if (mysql_num_rows($result1) == 0 ) // User doesn't exist
    { 
		// User doesn't exist
		header("Location: forgotpassdon.php?error=doesnot");
		exit();
    }
	...
	{ 
		...
		$str=str_shuffle($str);
		$str=substr($str,0,8);
		$result2 = mysql_query("update donor set token='$str' WHERE email='$email'");
		...
		https://$host/reset.php?token=$str&email=$email";
...
================================================== -->
  <body>
      ...
      <div class="row">
        <div class="col-lg-4">	
<h3>A link to reset your password has been sent to your email.<br>Please check your email including spam.<br>If you didn't get the email,<br> <a href="forgotpassdon.php" class="normal">Click here</a></h3>
	 </div><!-- /.col-lg-4 -->
